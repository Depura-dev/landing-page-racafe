...
const OPTIONS = {
  ...
  variableHeight: true,
  responsive: [{
    breakpoint: _libraries_utils__WEBPACK_IMPORTED_MODULE_1__.BREAKPOINTS.get('s'),
    settings: {
      slidesToScroll: numbersSlider.s,
      slidesToShow: numbersSlider.s
    }
  }, {
    breakpoint: _libraries_utils__WEBPACK_IMPORTED_MODULE_1__.BREAKPOINTS.get('m'),
    settings: {
      slidesToScroll: numbersSlider.m,
      slidesToShow: numbersSlider.m
    }
  }, {
    breakpoint: _libraries_utils__WEBPACK_IMPORTED_MODULE_1__.BREAKPOINTS.get('l'),
    settings: {
...
/* harmony export */   "haveCookie": () => (/* binding */ haveCookie),
...
/* harmony export */   "textEN": () => (/* binding */ textEN)
/* harmony export */ });
...
//TextEN con base en WPML
function textEN(textSP, textEN) {
  let language = $(".language2").find(".wpml-ls-current-language").find(".wpml-ls-display").text();

  return language == 'EN' ? textEN : textSP;
  // return language;
}
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_carousel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/carousel */ "./js/components/carousel.js");
/* harmony import */ var _components_reports_news__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/reports-news */ "./js/components/reports-news.js");
/* harmony import */ var _components_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/menu */ "./js/components/menu.js");
